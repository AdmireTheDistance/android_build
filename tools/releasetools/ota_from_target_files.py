...
""" % bcb_dev)
  ...
  #    oem_props, oem_dict, OPTIONS.info_dict))
  script.Print("=============================================")
  script.Print("  _  _ __ _ ____ ____ ____ _ ____ _ ____ _   ")
  script.Print("  |__| | \| [__] |--- |--- | |___ | |--| |__ ")
  script.Print("                                             ")
  script.Print("   ____   ___  __    __        __   ____     ")
  script.Print("  6MMMMb. `MM 6MMb  6MMb      `MM  6MMMMb    ")
  script.Print(" 6M'   Mb  MM69 `MM69 `Mb      MM MM'  `Mb   ")
  script.Print(" MM    `'  MM'   MM'   MM      MM       MM   ")
  script.Print(" MM        MM    MM    MM      MM      .M9   ")
  script.Print(" MM        MM    MM    MM      MM   MMMM     ")
  script.Print(" YM.   d9  MM    MM    MM      MM      `Mb   ")
  script.Print("  YMMMM9  _MM_  _MM_  _MM_    _MM_      MM   ")
  script.Print("                                        MM   ")
  script.Print("                                  MM.  ,M9   ")
  script.Print("              ~by Morningstar      YMMMM9    ")
  script.Print("                                             ")
  script.Print("=============================================")
